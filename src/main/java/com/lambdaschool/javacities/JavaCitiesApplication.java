...
public class JavaCitiesApplication {
	...
	public static final String QUEUE_NAME_SECRET = "Secret";
	public static final String QUEUE_NAME_CITIES1 = "Cities1";
	public static final String QUEUE_NAME_CITIES2 = "Cities2";
